...
public class TestThriftService {
    ...
    public interface AsyncIface {
        ...
        public void echo(String message, AsyncMethodCallback resultHandler)
                throws TException;
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public void sendEcho(String message) throws TException {
            echo_args args = new echo_args();
            args.setMessage(message);
            sendBase("echo", args);
        }

        public String recvEcho() throws TException {
